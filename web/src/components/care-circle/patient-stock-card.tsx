  ...
  return (
    <>
      <button
        ...
        className="bg-card border border-border rounded-2xl p-5 flex flex-col justify-between shadow-sm text-left cursor-pointer transition-colors hover:border-primary/40"
      >
        {card}
      </button>
